        ...
        Pass
        {
            ...
            fragment_output frag (v2f i)
            {
                ...
                */
                ...
                real3 color = real3(lerpFactor,lerpFactor,lerpFactor);
                fragment_output o;
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            fragment_output frag (v2f i)
            {
                ...
                if(envDistance > _MaxDistance)
                    envDistance = _MaxDistance;
                
                if(envDistance < _MinDistance)
                    envDistance = _MinDistance;
